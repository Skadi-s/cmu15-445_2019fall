...
class ArcReplacer {
 ...
 private:
  ...
  void ReplaceInternal(std::optional<ArcStatus> ghost_status = std::nullopt);
  auto EvictInternal(std::optional<ArcStatus> ghost_status = std::nullopt) -> std::optional<frame_id_t>;
};
